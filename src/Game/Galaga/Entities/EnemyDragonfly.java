...
public class EnemyDragonfly extends BaseEntity {
    ...
    int timeAlive=0;
    public EnemyDragonfly(int x, int y, int width, int height, Handler handler,int row, int col) {
        super(x, y, width, height, Images.galagaEnemyDragonfly[0], handler);
        this.row = row;
        this.col = col;
        BufferedImage[] idleAnimList= new BufferedImage[2];
        idleAnimList[0] = Images.galagaEnemyDragonfly[0];
        idleAnimList[1] = Images.galagaEnemyDragonfly[1];
        idle = new Animation(512,idleAnimList);
        turn90Left = new Animation(128,Images.galagaEnemyDragonfly);
        spawn();
        speed = 4;
