...
public class GalagaState extends State {
    ...
    public void render(Graphics g) {
        ...
        if (Mode.equals("Stage")) {
            ...
            g.drawImage(titleAnimation.getCurrentFrame(),handler.getWidth()/2-380,handler.getHeight()-handler.getHeight()+20,handler.getWidth()/2,handler.getHeight()-470,null);
